...
from apps.main.models import Department, Branch
...
class ProfileView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        from apps.skill_sessions.views import get_user_statistics
...
def user_profile_details(request, user_id):
    ...
    from apps.skill_sessions.models import SessionReview, SkillSwapSession
