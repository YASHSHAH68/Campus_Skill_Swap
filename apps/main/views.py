...
from apps.skill_sessions.models import SkillSwapRequest, SkillSwapSession

def home(request):
    from django.contrib.auth.models import User
    from apps.skills.models import Skill, OfferedSkill
...
class DashboardView:
    ...
    def as_view(cls):
        ...
        def dashboard_view(request):
            from apps.skills.models import DesiredSkill, OfferedSkill
            from apps.skill_sessions.models import SkillSwapSession
            ...
            from apps.skill_sessions.models import SkillSwapRequest
